...
function drawLayerSymbols(painter, sourceCache, layer, coords, isText, translate, translateAnchor,
    ...
    for (const segmentState of tileRenderState) {
        ...
        if (painter.terrain) painter.terrain.setupElevationDraw(state.tile, state.program, {useDepthForOcclusion: false, labelPlaneMatrixInv: state.labelPlaneMatrixInv}, new GlobeTile(state.tile.tileID.canonical, tr.pixelsPerMeter));
